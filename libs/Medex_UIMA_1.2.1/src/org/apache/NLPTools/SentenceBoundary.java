					...
					if (dot_num>0){
						...
						if (dot_num==1){
							...
							if (word.charAt(0)=='.'){
								...
								if ((next_token!=null) && !Global.Util.is_sentence_start(next_word) && (this.abbr_map.containsKey(word.toLowerCase()) || this.abbr_map.containsKey(word.substring(0, word.length()-1).toLowerCase()))   ){
